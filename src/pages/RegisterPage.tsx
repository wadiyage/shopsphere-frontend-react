...
import ShoppingExperience from "../assets/images/auth/toa-heftiba--abWByT3yg4-unsplash.jpg"
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden">
                <div className="lg:flex">
                    <div className="lg:w-1/2 min-h-full relative hidden lg:block">
                        <img
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            autoFocus
                                            className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ${errors.firstName ? 'border-red-300' : 'border-gray-300'
                                                }`}
                                        />
                                        {errors.firstName && (
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ${errors.lastName ? 'border-red-300' : 'border-gray-300'
                                                }`}
                                        />
                                        {errors.lastName && (
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 pr-12 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ${errors.confirmPassword ? 'border-red-300' : 'border-gray-300'
                                                }`}
                                        />
                                        <button
                                            type="button"
                                ...
                                <div className="text-left">
                                    <p className="text-sm text-gray-600">
                                        ...
                                        <NavLink to="/login" className="text-blue-600 hover:text-blue-800 focus:outline-none focus:underline transition duration-200 font-medium">
                                            Login
                                        </NavLink>
                                    </p>
                                </div>
